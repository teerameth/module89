...
class DopeNetwork(nn.Module):
    def __init__(
        ...
        efficientnet_b0 = models.efficientnet_b0(pretrained=True).features
        ...
        for i_layer in range(4): self.efficient.add_module(str(i_layer), efficientnet_b0[i_layer])
        ...
        i_layer = 4
        self.efficient.add_module(str(i_layer), nn.Conv2d(40, 20, kernel_size=3, stride=1, padding=1))
        ...
        self.m1_2 = DopeNetwork.create_stage(20, numBeliefMap, True)
        self.m2_2 = DopeNetwork.create_stage(20 + numBeliefMap, numBeliefMap, False)
        self.m3_2 = DopeNetwork.create_stage(20 + numBeliefMap, numBeliefMap, False)
        self.m4_2 = DopeNetwork.create_stage(20 + numBeliefMap, numBeliefMap, False)
        self.m5_2 = DopeNetwork.create_stage(20 + numBeliefMap, numBeliefMap, False)
        self.m6_2 = DopeNetwork.create_stage(20 + numBeliefMap, numBeliefMap, False)
...
if __name__ == '__main__':
    pth_list = glob.glob("/media/teera/SSD250GB/model/belief/chessboard_mono_6_stage_efficientB0/*.pth")
